#CableX/scripts/lazywaveIteration_mixedbuoy.py
...
from cableIteration.lazywave_cable_mixedbuoy import lazywave_cable_mixbuoy
import globals
...
def main():
    ...
    lazywavecable = lazywave_cable_mixbuoy('../basemodel/LW_BaseModel.yml', 'LW_SOL','LW_EOL', 'Clamp ref', '1000kg_SOL')
