...
from cableIteration.rcdc_cable import rcdc_cable
import globals
...
def main():
    ...
    rcdccable = rcdc_cable('../basemodel/RCDC_Basemodel.yml', 'LW_SOL', 'LW_EOL', 'RPW_SOL', 'RPW_EOL', 'Tether_SOL_1', 'Tether_SOL_2', 'Tether_EOL_1', 'Tether_EOL_2', 
