#CableX/scripts/rcdcIteration.py
...
from cableIteration.rcdc_cable_mixedbuoy import rcdc_cable_mixedbuoy
import globals
...
def main():
    ...
    rcdccable = rcdc_cable_mixedbuoy('../basemodel/RCDC_Basemodel.yml', 'LW_SOL', 'LW_EOL', 'RPW_SOL', 'RPW_EOL', 'Tether_SOL_1', 'Tether_SOL_2', 'Tether_EOL_1', 'Tether_EOL_2', 
                                    'Clamp_SOL', 'Clamp_EOL', '1000kg_SOL', '1000kg_EOL', 'Clamp ref')
    rcdccable.generate_models(LoadingSpace)
    rcdccable.print_results()
