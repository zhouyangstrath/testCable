...
from cableIteration.fulllazywave_cable_mixedbuoy import full_lazywave_cable_mixedbuoy
import globals
...
def main():
    ...
    lazywavecable = full_lazywave_cable_mixedbuoy('../basemodel/Full_LW_BaseModel.yml', 'LW_SOL','LW_EOL', 'Clamp ref', '1000kg_SOL')
